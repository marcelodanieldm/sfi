...
# Cabeceras de seguridad válidas siempre (dev y prod)
...
MP_SUBSCRIPTION_AMOUNT   = os.environ.get('MP_SUBSCRIPTION_AMOUNT', '39999')
MP_SUBSCRIPTION_AMOUNT_BIMONTHLY = os.environ.get('MP_SUBSCRIPTION_AMOUNT_BIMONTHLY', '69999')
