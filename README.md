...
MP_WEBHOOK_SECRET=...
MP_PREAPPROVAL_PLAN_ID=...       # Equivalente al Price ID de Stripe
MP_SUBSCRIPTION_AMOUNT=9990      # Solo si no usás Plan ID
MP_SUBSCRIPTION_CURRENCY=ARS     # Solo si no usás Plan ID
